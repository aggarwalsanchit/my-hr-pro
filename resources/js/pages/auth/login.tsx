...
export default function Login({ status, canResetPassword, demoBusinesses = [] }: LoginProps) {
    ...
    useEffect(() => {
        ...
        if (isDemo) {
            setData({
                email: isSaas ? 'company@myhrpro.com' : 'company@myhrpro.com',
                password: 'password',
                remember: false
            });
        }
