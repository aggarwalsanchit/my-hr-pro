...
export default function EmailSettings() {
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    host: settings.email_host || 'smtp.myhrpro.com',
    port: settings.email_port || '587',
    username: settings.email_username || 'user@myhrpro.com',
    password: settings.email_password ? '••••••••••••' : '',
    encryption: settings.email_encryption || 'tls',
    fromAddress: settings.email_from_address || 'noreply@myhrpro.com',
    fromName: settings.email_from_name || 'MyHrPro System'
  });
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      placeholder="noreply@myhrpro.com"
                    />
                  </div>
