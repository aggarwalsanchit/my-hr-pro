  ...
  const TextBlock = ({ centered = false }: { centered?: boolean }) => (
    <div className={centered ? 'text-center' : ''}>
      ...
      <div className="text-gray-600 mb-8 leading-relaxed" dangerouslySetInnerHTML={{
        __html: (sectionData.story_content || t('Founded by HR and tech enthusiasts, MyHR Pro was created to replace cumbersome spreadsheets and manual processes with a modern, all-in-one HR platform.')).replace(/\n/g, '</p><p class="mb-6">')
      }} />
      {stats.length > 0 && (
