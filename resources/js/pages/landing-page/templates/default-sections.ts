export const defaultLandingPageSections = {
  sections: [
      ...
      screenshots_list: [
        {
          ...
          alt: 'MyHR Pro Dashboard Overview',
    ...
    // },
    {
      ...
      story_content: 'Founded by HR and tech enthusiasts, MyHR Pro was created to replace cumbersome spreadsheets and manual processes with a modern, all-in-one HR platform.',
      image: '',
      ...
      testimonials: [
        {
          ...
          content: 'MyHR Pro has made managing employee records and attendance effortless. Our HR team saves hours every week!',
          rating: 5
        },
        {
          name: 'Robert Smith',
        ...
        },
        {
          ...
          content: 'From recruitment to performance management, MyHR Pro covers everything we need in one platform.',
          rating: 5
        },
        {
          name: 'David Lee',
          ...
          content: 'Recruitment and onboarding have never been smoother. MyHR Pro platform is intuitive and efficient.',
          rating: 5
        },
        {
          name: 'Samantha Green',
          ...
          content: 'Payroll processing is now quick and error-free thanks to MyHR Pro. It has transformed our monthly workflow.',
          rating: 5
        },
        {
          name: 'Michael Brown',
