...
class WebhookSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $webhookTemplates = [
            ['module' => 'New User', 'method' => 'POST', 'url' => 'https://myhrpro.com/webhooks/new-user'],
            ['module' => 'New Appointment', 'method' => 'POST', 'url' => 'https://myhrpro.com/webhooks/new-appointment'],
            ['module' => 'New User', 'method' => 'GET', 'url' => 'https://myhrpro.com/api/user-created'],
            ['module' => 'New Appointment', 'method' => 'GET', 'url' => 'https://myhrpro.com/webhooks/appointment-status']
        ];
