...
class EmailSettingController extends Controller
{
    ...
    public function getEmailSettings()
    {
        $settings = [
            ...
            'host' => getSetting('email_host', 'smtp.myhrpro.com'),
            'port' => getSetting('email_port', '587'),
            'username' => getSetting('email_username', 'user@myhrpro.com'),
            'password' => getSetting('email_password', ''),
            'encryption' => getSetting('email_encryption', 'tls'),
            'fromAddress' => getSetting('email_from_address', 'noreply@myhrpro.com'),
            'fromName' => getSetting('email_from_name', 'MyHRPro System')
        ];
