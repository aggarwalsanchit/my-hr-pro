...
class MailConfigService
{
    public static function setDynamicConfig()
    {
        ...
        $settings = [
            ...
            'host' => $getSettings['email_host'] ?? 'smtp.myhrpro.com',
            ...
            'fromAddress' => $getSettings['email_from_address'] ?? 'noreply@myhrpro.com',
            'fromName' => $getSettings['email_from_name'] ?? 'MyHRPro System'
        ];
