        ...
        return [
            'sections' => [
                ...
                [
                    ...
                    'members' => [
                        ['name' => 'John Doe', 'role' => 'CEO & Founder', 'bio' => 'Experienced HR tech entrepreneur passionate about building intuitive HR solutions.', 'image' => '', 'linkedin' => '#', 'email' => 'john@myhrpro.com'],
                        ['name' => 'Jane Smith', 'role' => 'CTO', 'bio' => 'Leads the tech team to create scalable and secure HR platforms.', 'image' => '', 'linkedin' => '#', 'email' => 'jane@myhrpro.com'],
                        ['name' => 'Michael Lee', 'role' => 'Head of Product', 'bio' => 'Designs user-centric features to simplify HR processes.', 'image' => '', 'linkedin' => '#', 'email' => 'michael@myhrpro.com'],
                        ['name' => 'Emily Davis', 'role' => 'HR Manager', 'bio' => 'Oversees employee engagement, recruitment, and HR operations.', 'image' => '', 'linkedin' => '#', 'email' => 'emily@myhrpro.com']
                    ]
                ],
                [
                    'key' => 'testimonials',
